...
const personas = {
  freelancer: {
    headline: "Международные платежи для фрилансеров с AI-оптимизацией",
  ...
  business: {
    headline: "AI-платежи для бизнеса: надежно и прозрачно",
  ...
  crypto: {
    ...
    sub: "Стабильная доходность, быстрый доступ к DeFi, AI-подбор лучших программ.",
    cta: "Узнать о стейблкоин-программах",
    color: "bg-yellow-500",
  },
  general: {
    headline: "Международные платежи с AI-оптимизацией",
    sub: "Сравните 50+ способов перевода и получите персональную рекомендацию от ИИ за 30 секунд.",
    cta: "Получить AI-рекомендацию",
    color: "bg-indigo-600",
  },
};
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-900">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-6 py-12 gap-8">
        <div className="flex-1 flex flex-col gap-6">
          ...
          <ul className="space-y-2 text-base md:text-lg">
            ...
            <li>✅ AI подбирает лучший маршрут</li>
        ...
        <div className="flex-1 flex flex-col items-center">
          {/* Иллюстрация/AI-робот — можно заменить на SVG/картинку */}
      ...
      <section id="solutions" className="bg-white py-12 px-6 border-t border-gray-200">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              <li>• AI находит самый выгодный маршрут за 30 секунд</li>
      ...
      <section className="py-12 px-6 max-w-7xl mx-auto">
        <h2 className="text-2xl font-bold mb-8 text-center">🤖 AI-возможности платформы</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <FeatureCard title="AI-калькулятор" desc="Мгновенно рассчитывает лучшие маршруты перевода с учетом комиссии, скорости и надежности."/>
          <FeatureCard title="Smart Routing" desc="AI анализирует 50+ способов и выбирает оптимальный путь для вашей задачи."/>
          ...
          <table className="min-w-full text-sm text-left border rounded-lg overflow-hidden">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-4 py-2">AI-рекомендации</th>
      ...
      <section id="reviews" className="py-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <ReviewCard name="Александр, фрилансер" text="Переводы стали быстрее и дешевле, чем через банк. AI реально помогает!"/>
          <ReviewCard name="Елена, директор" text="Для бизнеса — находка. Прозрачные условия, никаких скрытых комиссий."/>
          <ReviewCard name="Максим, инвестор" text="AI-подбор DeFi-программ — топ! Доходность выше, чем на бирже."/>
        </div>
      </section>
      ...
      <section id="faq" className="bg-white py-12 px-6 border-t border-gray-200">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <FAQItem q="Как работает AI-калькулятор?" a="Он анализирует параметры перевода и подбирает оптимальный маршрут по комиссиям, скорости и надежности."/>
      ...
      <section id="contact" className="py-12 px-6 max-w-7xl mx-auto text-center">
        ...
        <p className="mb-6 text-lg">Оставьте заявку — и получите персональную AI-рекомендацию бесплатно!</p>
      ...
      {/* Footer */}
      <footer className="py-8 text-center text-gray-400 text-sm border-t mt-8">© 2024 8sh.ru — Международные платежи с AI-оптимизацией</footer>
    </div>
  );
}
...
function AICalculator() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-md">
      <h3 className="font-bold text-lg mb-4">🧮 AI-калькулятор перевода</h3>
      ...
      <div className="text-gray-500 text-xs mb-2">🤖 AI анализирует 50+ способов...</div>
      <div className="bg-gray-50 rounded-lg p-3 mb-2">
        {recs.map((r, i) => (
          <div key={i} className="flex justify-between items-center py-1 text-sm">
            <span className="font-medium">🥇🥈🥉"[i]" {r.label}</span>
