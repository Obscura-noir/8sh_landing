...
const faqs = [
...

  {
    ...
    answer: 'Нет, не нужны. Мы берем на себя всю техническую часть: настройку, интеграцию, поддержку. Ваша задача — только использовать готовые инструменты. Мы также обучаем ваших сотрудников работе с ИИ.',
  },

  {
    question: 'Безопасны ли российские ИИ для конфиденциальных данных?',
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Отвечаем на важные вопросы о внедрении ИИ
          </p>
        </motion.div>
