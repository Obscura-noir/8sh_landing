...
const services = [
  ...
  },
  {
    ...
    description: 'Выбираем 1 процесс, внедряем ИИ-решение, обучаем 2-3 сотрудников',
  ...
  },
  {
    ...
    description: 'Техническая поддержка 24/7, обновление ИИ-моделей, добавление новых функций',
